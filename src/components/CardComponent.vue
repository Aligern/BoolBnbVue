  ...
  <div id="ls-card-container" class="">
    ...
    <div class="ls-card">
      ...
      <div class="card-content">
        ...
        <!-- button -->
        <router-link :to="{ name: 'details', params: { slug: item.slug } }" class="button">
          More informations
          <span>
    ...
    <div class=" d-flex mx-5">
      <router-link :to="{ name: 'results', params: { slug: item.services.slug } }" v-for="service in item.services"
        :key="item.id" class="p-3 text-black rounded text-bg-warning d-flex">
...
<script>
  ...
  export default {
    ...
    mounted() {
      console.log('item:', this.item.services);
    },
    methods: {
